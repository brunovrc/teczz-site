  ...
  return (
    <>
      ...
      <div className="grain-overlay bg-black text-white font-grotesk">
        ...
        <AnimatePresence>
          {mobileOpen && (
            ...
            >
              ...
              {['Soluções', 'Cases', 'Sobre', 'Investimento', 'Contato'].map((link, i) => (
                <motion.a
                  key={link}
        ...
        {/* ─── INVESTIMENTO ─── */}
        <div aria-hidden="true" className="section-sep" />
        <section id="investimento" className="px-6 md:px-10 py-24 md:py-36">
          <motion.div variants={containerVariants} initial="hidden" whileInView="visible" viewport={vp}>

            <LampHeading label="Investimento" className="mb-16">
              <AnimatedHeading
                as="h2"
            ...
            <ul className="grid grid-cols-1 md:grid-cols-6 gap-5 mb-10">
              <PricingCard
